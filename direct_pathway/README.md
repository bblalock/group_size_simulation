...
4. Calculate disparity measures:
   - Rate-based measures:
     - $\text{DisparityRatio} = \frac{\text{GroupRate}_{disadv}}{\text{GroupRate}_{adv}} = \frac{1 + \theta \cdot \frac{1-\pi}{\pi}}{1-\theta}$
     - $\text{DisparityDifference} = \text{GroupRate}_{disadv} - \text{GroupRate}_{adv} = \text{avgRate} \cdot \left(\theta \cdot \frac{1-\pi}{\pi} + \theta\right)$
